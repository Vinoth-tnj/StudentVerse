...
public class StudentRegister extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        login = findViewById(R.id.logredir);
        ...
        boolean status1=sharedPreferences.getBoolean("status2",false);
        Integer status=sharedPreferences.getInt("status",0);
        if (status == 2){
            Intent i=new Intent(StudentRegister.this,StudentDashboard.class);
            startActivity(i);
            finish();
        }
